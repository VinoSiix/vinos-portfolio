        ...
        <div className="grid lg:grid-cols-1 gap-12 mx-auto max-w-2xl">
          ...
          <div data-aos="fade-right">
            ...
            <div className="space-y-6 mb-8">
              <div className="flex items-center space-x-4 group transform transition-all duration-300 hover:scale-105">
                <div className="p-3 glass-effect rounded-full group-hover:border-primary/50 transition-all duration-300 group-hover:animate-wine-glow">
              ...
              <div className="flex items-center space-x-4 group transform transition-all duration-300 hover:scale-105">
                ...
                <div>
                  <h4 className="font-semibold text-foreground group-hover:text-primary transition-colors duration-300">Available</h4>
              ...
              <div className="flex items-center space-x-4 group transform transition-all duration-300 hover:scale-105">
                ...
                <div>
                  <h4 className="font-semibold text-foreground group-hover:text-primary transition-colors duration-300">Remote</h4>
