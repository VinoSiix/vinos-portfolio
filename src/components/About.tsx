...
const About = () => {
  const skills = [
    ...
    { category: "Backend", items: ["Node.js", "Python", "FastAPI", "Express", "MongoDB"] },
    { category: "AI/ML", items: ["OpenAI API", "n8n", "Automation", "LLM Integration", "Data Processing"] },
          ...
          <div data-aos="fade-right">
            ...
            <div className="grid grid-cols-2 gap-4 mb-8">
              {highlights.map((item, index) => (
                <div key={index} className="flex items-start space-x-3 group transform transition-all duration-300 hover:scale-105">
                  <div className="text-primary group-hover:animate-wine-glow transition-all duration-300 transform group-hover:scale-110">
                    {item.icon}
                  </div>
                  <div>
